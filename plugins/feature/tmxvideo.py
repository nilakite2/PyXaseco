...
async def _resolve_current_tmx_ref(aseco: "Aseco", challenge=None) -> tuple[int, str]:
    ...
    section = ""
    try:
        from pyxaseco.plugins.service.tmx import get_tmx_section
    ...
    if direct > 0:
        ...
        try:
            from pyxaseco.plugins.service.tmx import tmx_prefix_for_section
    ...
    if nested > 0:
        ...
        try:
            from pyxaseco.plugins.service.tmx import TMX_HOST_ALIASES, tmx_prefix_for_section
    ...
    try:
        from pyxaseco.plugins.service.tmx import resolve_tmx_track_id
...
async def _resolve_video_host(aseco: "Aseco", prefix: str) -> str:
    ...
    try:
        from pyxaseco.plugins.service.tmx import tmx_public_host_for_section

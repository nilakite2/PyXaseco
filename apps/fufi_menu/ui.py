        ...
        if plugins_toml.exists():
            try:
                ...
                aliases = {
                    ...
                    "app/public_stats": ["bridge.public_stats.php"],
                    ...
                    "app/records_eyepiece": ["records_eyepiece.app.php"],
                    "app/records_local": [
                        "chat.records.php",
                        "chat.records2.php",
                        "chat.recrels.php",
                    ],
                    "app/dedimania": ["plugin.dedimania.php", "chat.dedimania.php"],
                    "app/players": [
                        "chat.players.php",
                        "chat.players2.php",
                        "chat.wins.php",
                    ...
                    "app/player_stats": ["chat.stats.php"],
                    "app/server_info": ["chat.server.php"],
                    "app/track": ["chat.songmod.php", "plugin.track.php"],
                    "app/social_chat": ["chat.me.php"],
                    "app/tmx": ["plugin.tmxinfo.php"],
                    "app/trial_records": ["plugin.trial_records.php"],
                    "app/records_rpg": ["plugin.records_rpg.php"],
                    "app/mania_karma": ["plugin.rasp_karma.php"],
                    "app/jfreu": ["jfreu.plugin.php", "jfreu.chat.php"],
                    "app/cplive": ["plugin.cplive.php"],
                    "app/best_cp_times": ["plugin.best_cp_times_v2.php"],
                    "app/bestfinishes": ["plugin.bestfinishes.php"],
                    "app/cpll": ["plugin.cpll.php"],
                    "app/tmxvideo": ["plugin.tmxvideo.php"],
                    "app/ztrack": ["plugin.ztrack.php"],
                    "app/fufi_menu": ["plugin.fufi_menu.php"],
                    ...
                    "service/dedimania": ["plugin.dedimania.php"],

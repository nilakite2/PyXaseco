...
/plugins  - Show active apps and loadout entries
...
def register(aseco: 'Aseco'):
    ...
    aseco.add_chat_command(
        'xaseco',
        'Displays info about this PyXaseco',
        owner='chat/server',
        app='server',
        category='chat-server',
        usage='/xaseco',
    ...
    aseco.add_chat_command(
        'plugins',
        'Displays active apps and loadout entries',
        owner='chat/server',
        app='server',
        category='chat-server',
        usage='/plugins',
    ...
    aseco.add_chat_command(
        'nations',
        'Displays top 10 most visiting nations',
        owner='chat/server',
        app='server',
        category='chat-server',
        usage='/nations',
...
async def chat_server(aseco: 'Aseco', command: dict):
    ...
    feature_votes = False
    try:
        from apps.rasp.rankings import feature_votes as _fv

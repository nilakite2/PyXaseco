...
class VotingCommandSurface(Component):
    def __init__(self):
        super().__init__(
            component_id='voting.commands',
            description='Vote state and player/server vote command surface.',
            commands=(
...
class VotingCallbackSurface(Component):
    def __init__(self):
        super().__init__(
            component_id='voting.callbacks',
            description='Vote lifecycle, expiry, and moderation callback surface.',
            callbacks=(
...
VOTING_COMMAND_SURFACE = VotingCommandSurface()
VOTING_CALLBACK_SURFACE = VotingCallbackSurface()


def get_command_component() -> VotingCommandSurface:
    return VOTING_COMMAND_SURFACE


def get_callback_component() -> VotingCallbackSurface:
...
__all__ = [
    ...
    'register_commands',
    'register_callbacks',
    'VotingCommandSurface',
    'VotingCallbackSurface',

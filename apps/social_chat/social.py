...
from . import chat_backend as _impl
...
def register_commands(aseco) -> None:
    ...
    for name, help_text in cmds:
        aseco.add_chat_command(name, help_text, app='social_chat', category='chat-social')
...
class RaspSocialSurface(Component):
    def __init__(self):
        super().__init__(
            ...
            description='Private-message and social chat command surface.',
            commands=(

...
def register(aseco: 'Aseco'):
    ...
    aseco.add_chat_command(
        'summary',
        'Shows summary of all your records',
        owner='chat/records2',
        app='records_local',
        category='chat-records',
        usage='/summary [login]',
    ...
    aseco.add_chat_command(
        'topsums',
        'Displays top 100 of top-3 record holders',
        owner='chat/records2',
        app='records_local',
        category='chat-records',
        usage='/topsums',
        display_name='topsums',
        order=115,
    )
    aseco.add_chat_command(
        'toprecs',
        'Displays top 100 ranked records holders',
        owner='chat/records2',
        app='records_local',
        category='chat-records',
        usage='/toprecs',
        display_name='toprecs',
        order=116,
    )

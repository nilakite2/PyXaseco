...
def register(aseco: "Aseco"):
    aseco.add_chat_command(
        "ranks",
        "Displays list of online ranks/nicks",
        owner='chat/players2',
        app='players',
    ...
    aseco.add_chat_command(
        "clans",
        "Displays list of online clans/nicks",
        owner='chat/players2',
        app='players',
        category='chat-players',
        usage='/clans',
    ...
    aseco.add_chat_command(
        "topclans",
        "Displays top ranked clans",
        owner='chat/players2',
        app='players',
        category='chat-players',
        usage='/topclans',
        display_name='topclans',
        order=203,
    )
...
async def _get_rank_value(aseco: 'Aseco', login: str) -> int | None:
    """
...
async def chat_ranks(aseco: "Aseco", command: dict):
    ...
    for pl in aseco.server.players.all():
        rank = await _get_rank_value(aseco, pl.login)
        if rank is None:
